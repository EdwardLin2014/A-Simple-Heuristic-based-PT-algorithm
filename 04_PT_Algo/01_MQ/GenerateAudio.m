...
for t = 1:numMusics
    ...
    tic
    if t <= 137
        audiowrite([AudioOutDirStr, '/MQ/iSTFT_1024_4096_256_42_20_4/Voice/',WavFileDirs{t}(end-14:end)], Voice.ISP_iSTFT_y, fs );
        audiowrite([AudioOutDirStr, '/MQ/iSTFT_1024_4096_256_42_20_4/Song/',WavFileDirs{t}(end-14:end)], Song.ISP_iSTFT_y, fs );
        audiowrite([AudioOutDirStr, '/MQ/AS_1024_4096_256_42_20_4/Voice/',WavFileDirs{t}(end-14:end)], Voice.ISP_AS_y, fs );
        audiowrite([AudioOutDirStr, '/MQ/AS_1024_4096_256_42_20_4/Song/',WavFileDirs{t}(end-14:end)], Song.ISP_AS_y, fs );
    else
        audiowrite([AudioOutDirStr, '/MQ/iSTFT_1024_4096_256_42_20_4/Voice/',WavFileDirs{t}(end-15:end)], Voice.ISP_iSTFT_y, fs );
        audiowrite([AudioOutDirStr, '/MQ/iSTFT_1024_4096_256_42_20_4/Song/',WavFileDirs{t}(end-15:end)], Song.ISP_iSTFT_y, fs );
        audiowrite([AudioOutDirStr, '/MQ/AS_1024_4096_256_42_20_4/Voice/',WavFileDirs{t}(end-15:end)], Voice.ISP_AS_y, fs );
        audiowrite([AudioOutDirStr, '/MQ/AS_1024_4096_256_42_20_4/Song/',WavFileDirs{t}(end-15:end)], Song.ISP_AS_y, fs );
    end
