...
struct Partial *PT_Algo_SMS_C(double *mXdB, double *ploc, double *vploc, struct ConfParm Parm, int *NumOfTracks)
{
    ...
    double FreqCond, DiffFreq, minDiffFreq;
    *NumOfTracks = 0;
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    Partials = PT_Algo_SMS_C(mXdB, ploc, vploc, Parm, &NumOfTracks);
