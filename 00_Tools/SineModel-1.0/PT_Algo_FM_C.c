...
struct Partial *PT_Algo_FM_C(double *mXdB, double *ploc, double *vploc, struct ConfParm Parm, int *NumOfTracks)
{
        ...
        int nrhs, const mxArray *prhs[])
{
    ...
    Parm.freqDevSlope = mxGetScalar(mxGetField(prhs[3], 0, "freqDevSlope"));
    Parm.freqDevOffset = (int)mxGetScalar(mxGetField(prhs[3],0,"freqDevOffset"));
    Parm.MagCond = (int)mxGetScalar(mxGetField(prhs[3],0,"MagCond"));
    ...
    Partials = PT_Algo_FM_C(mXdB, ploc, vploc, Parm, &NumOfTracks);
