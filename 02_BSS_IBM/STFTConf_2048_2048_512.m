...
Parm.N = 2048;                  % Analysis FFT Size, 92.88ms
...
for t = 1:numMusics
    ...
    tic
    if t <= 137
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/2048_2048_512/Voice/',WavFileDirs{t}(end-14:end)], Voice.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/2048_2048_512/Song/',WavFileDirs{t}(end-14:end)], Song.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/2048_2048_512/Voice/',WavFileDirs{t}(end-14:end)], Voice.ISP_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/2048_2048_512/Song/',WavFileDirs{t}(end-14:end)], Song.ISP_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_AS/2048_2048_512/Voice/',WavFileDirs{t}(end-14:end)], Voice.ISP_AS_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_AS/2048_2048_512/Song/',WavFileDirs{t}(end-14:end)], Song.ISP_AS_y, fs);
    else
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/2048_2048_512/Voice/',WavFileDirs{t}(end-15:end)], Voice.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/2048_2048_512/Song/',WavFileDirs{t}(end-15:end)], Song.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/2048_2048_512/Voice/',WavFileDirs{t}(end-15:end)], Voice.ISP_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/2048_2048_512/Song/',WavFileDirs{t}(end-15:end)], Song.ISP_iSTFT_y, fs);    
        audiowrite([AudioOutDirStr, 'ISP_AS/2048_2048_512/Voice/',WavFileDirs{t}(end-15:end)], Voice.ISP_AS_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_AS/2048_2048_512/Song/',WavFileDirs{t}(end-15:end)], Song.ISP_AS_y, fs);
    end
