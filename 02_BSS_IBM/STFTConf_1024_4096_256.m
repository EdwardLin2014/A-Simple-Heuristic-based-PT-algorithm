...
for t = 1:numMusics
    ...
    tic
    if t <= 137
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/1024_4096_256/Voice/',WavFileDirs{t}(end-14:end)], Voice.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/1024_4096_256/Song/',WavFileDirs{t}(end-14:end)], Song.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/1024_4096_256/Voice/',WavFileDirs{t}(end-14:end)], Voice.ISP_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/1024_4096_256/Song/',WavFileDirs{t}(end-14:end)], Song.ISP_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_AS/1024_4096_256/Voice/',WavFileDirs{t}(end-14:end)], Voice.ISP_AS_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_AS/1024_4096_256/Song/',WavFileDirs{t}(end-14:end)], Song.ISP_AS_y, fs);
    else
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/1024_4096_256/Voice/',WavFileDirs{t}(end-15:end)], Voice.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'IBM_iSTFT/1024_4096_256/Song/',WavFileDirs{t}(end-15:end)], Song.IBM_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/1024_4096_256/Voice/',WavFileDirs{t}(end-15:end)], Voice.ISP_iSTFT_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_iSTFT/1024_4096_256/Song/',WavFileDirs{t}(end-15:end)], Song.ISP_iSTFT_y, fs);    
        audiowrite([AudioOutDirStr, 'ISP_AS/1024_4096_256/Voice/',WavFileDirs{t}(end-15:end)], Voice.ISP_AS_y, fs);
        audiowrite([AudioOutDirStr, 'ISP_AS/1024_4096_256/Song/',WavFileDirs{t}(end-15:end)], Song.ISP_AS_y, fs);
    end
